...
import SendMessageWhenCustomerChangesHisAddressHandler
  from "@domain/customer/event/handler/send-message-when-customer-changes-his-address.handler";
...
describe("Customer Change his address event tests", () => {
  ...
  it("should call SendMessageWhenCustomerChangesHisAddressHandler when an event is notified", () => {
    ...
    const expectedMessage = `Endereço do cliente: \x1b[32m${customer.id}\x1b[0m, \x1b[32m${customer.name}\x1b[0m alterado para: \x1b[33m${stringfiedAddress}\x1b[0m`;
